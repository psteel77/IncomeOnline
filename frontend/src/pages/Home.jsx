      ...
      <section id="categories-preview" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-cyan-50 to-teal-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-amber-600 font-semibold">Preview - Unlock full access with a donation</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Dummy Category 1 - Freelancing */}
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 bg-gradient-to-br from-white to-teal-50 relative overflow-hidden opacity-90">
              <div className="absolute top-2 right-2 bg-amber-500 text-white text-xs px-2 py-1 rounded-full font-bold">
                Preview
              </div>
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <CardTitle className="text-xl font-bold text-teal-800">Freelancing</CardTitle>
              ...
              <CardContent>
                <div className="bg-white/70 backdrop-blur-sm p-3 rounded-lg">
                  <p className="text-sm text-slate-700 font-medium mb-2">Popular platforms include:</p>
            ...
            {/* Dummy Category 2 - Surveys & Research */}
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 bg-gradient-to-br from-white to-cyan-50 relative overflow-hidden opacity-90">
              <div className="absolute top-2 right-2 bg-amber-500 text-white text-xs px-2 py-1 rounded-full font-bold">
                Preview
              </div>
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <CardTitle className="text-xl font-bold text-cyan-800">Surveys & Research</CardTitle>
                  <Star className="h-8 w-8 text-cyan-600" />
                </div>
                <CardDescription className="text-slate-600">
                  Share your opinions and get paid for your insights
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-white/70 backdrop-blur-sm p-3 rounded-lg">
                  <p className="text-sm text-slate-700 font-medium mb-2">Quick ROI opportunity:</p>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li>• Swagbucks</li>
                    <li>• Survey Junkie</li>
                    <li>• User Testing</li>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 bg-gradient-to-br from-white to-purple-50 relative overflow-hidden opacity-90">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-slate-600">
                  Create videos, write articles, or produce content
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-white/70 backdrop-blur-sm p-3 rounded-lg">
                  <p className="text-sm text-slate-700 font-medium mb-2">High earning potential:</p>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li>• YouTube</li>
                    <li>• Medium</li>
                    <li>• Substack</li>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 bg-gradient-to-br from-white to-green-50 relative overflow-hidden opacity-90">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-slate-600">
                  Sell products online through various platforms
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-white/70 backdrop-blur-sm p-3 rounded-lg">
                  <p className="text-sm text-slate-700 font-medium mb-2">Start your business:</p>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li>• Etsy</li>
                    <li>• Amazon FBA</li>
                    <li>• eBay</li>
          ...
          <div className="mt-12 text-center">
            <Card className="bg-gradient-to-br from-amber-50 to-yellow-100 border-2 border-amber-300 shadow-lg max-w-2xl mx-auto">
              <CardContent className="py-8">
                <Lock className="h-12 w-12 text-amber-600 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-amber-800 mb-3">Unlock All 8 Categories</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 relative overflow-hidden">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-xl font-bold text-teal-800">Upwork</CardTitle>
                  <Badge className="bg-teal-600">Freelancing</Badge>
                </div>
                <CardDescription className="text-slate-600 line-clamp-2">
                  World's largest freelancing platform with millions of jobs
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 relative">
                ...
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Earning Potential:</span>
                  <span className="font-semibold text-emerald-700">$500-$10,000+/mo</span>
                </div>
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Difficulty:</span>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 relative overflow-hidden">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-xl font-bold text-teal-800">Fiverr</CardTitle>
                  <Badge className="bg-teal-600">Freelancing</Badge>
                </div>
                <CardDescription className="text-slate-600 line-clamp-2">
                  Sell your services starting at $5, scale to thousands
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 relative">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/90 backdrop-blur-[2px] flex items-center justify-center">
                ...
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Earning Potential:</span>
                  <span className="font-semibold text-emerald-700">$100-$5,000+/mo</span>
                </div>
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Difficulty:</span>
                  <Badge>Easy</Badge>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 relative overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-slate-600 line-clamp-2">
                  Create videos and earn from ads, sponsorships, and more
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 relative">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/90 backdrop-blur-[2px] flex items-center justify-center">
                ...
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Earning Potential:</span>
                  <span className="font-semibold text-emerald-700">$100-$100,000+/mo</span>
                </div>
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Difficulty:</span>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 relative overflow-hidden">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-xl font-bold text-teal-800">Swagbucks</CardTitle>
                  <Badge className="bg-cyan-600">Surveys</Badge>
                </div>
                <CardDescription className="text-slate-600 line-clamp-2">
                  Quick ROI - Earn by taking surveys, watching videos, shopping
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 relative">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/90 backdrop-blur-[2px] flex items-center justify-center">
                ...
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Earning Potential:</span>
                  <span className="font-semibold text-emerald-700">$50-$200/mo</span>
                </div>
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Difficulty:</span>
                  <Badge>Easy</Badge>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 relative overflow-hidden">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-xl font-bold text-teal-800">Etsy</CardTitle>
                  <Badge className="bg-green-600">E-commerce</Badge>
                </div>
                <CardDescription className="text-slate-600 line-clamp-2">
                  Sell handmade, vintage items and craft supplies online
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 relative">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/90 backdrop-blur-[2px] flex items-center justify-center">
                ...
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Earning Potential:</span>
                  <span className="font-semibold text-emerald-700">$200-$5,000+/mo</span>
                </div>
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Difficulty:</span>
                  <Badge variant="secondary">Medium</Badge>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-2 border-teal-200 relative overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-slate-600 line-clamp-2">
                  Sell products on Amazon, they handle storage and shipping
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 relative">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/90 backdrop-blur-[2px] flex items-center justify-center">
                ...
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Earning Potential:</span>
                  <span className="font-semibold text-emerald-700">$1,000-$20,000+/mo</span>
                </div>
                <div className="flex items-center justify-between text-sm opacity-60">
                  <span className="text-slate-600">Difficulty:</span>
                  <Badge variant="destructive">Hard</Badge>
