    ...
    <section id="platforms-preview" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-700 via-pink-600 to-orange-500 mb-4" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.15)' }}>6 Top Rated Opportunities</h2>
          <p className="text-lg text-slate-600 mb-2">199+ verified platforms ready for you to explore</p>
          <p className="text-sm text-pink-600 font-semibold mb-3">Unlock full details with a donation</p>
